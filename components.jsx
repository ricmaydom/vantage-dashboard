...
function fmtDate(d){ if(!d) return "—"; const dt = new Date(d); if(isNaN(dt)) return "—"; return dt.toLocaleDateString("en-AU",{day:"numeric",month:"short",year:"numeric"}); }
function fmtShortDate(d){ if(!d) return "—"; const dt = new Date(d); if(isNaN(dt)) return "—"; return dt.toLocaleDateString("en-AU",{day:"numeric",month:"short"}); }
function agoText(d){
  if(!d) return "—";
  const dt = new Date(d);
  const now = new Date();
